...
| **VideoMambaPro** | Snakes and Ladders: Two Steps Up for VideoMamba | 2025 | ICCV 2025 | [paper](https://arxiv.org/abs/2406.19006) | [code](https://github.com/hotfinda/VideoMambaPro) |
...
| **STC** | Accelerating Streaming Video Large Language Models via Hierarchical Token Compression | 2025 | CVPR 2025 | [paper](https://arxiv.org/abs/2512.00891) | — |
| **EarlyTom** | EarlyTom: Early Token Compression Completes Fast Video Understanding | 2026 | CVPR 2026 | [paper](https://arxiv.org/abs/2605.30010) | — |
...
| **FastVLM** | FastVLM: Efficient Vision Encoding for Vision Language Models | 2025 | CVPR 2025 | [paper](https://arxiv.org/abs/2412.13303) | [code](https://github.com/apple/ml-fastvlm) |
| **MobileViCLIP** | MobileViCLIP: An Efficient Video-Text Model for Mobile Devices | 2025 | arXiv | [paper](https://arxiv.org/abs/2508.07312) | [code](https://github.com/MCG-NJU/MobileViCLIP) |
...
| **LLaVA-PruMerge** | LLaVA-PruMerge: Adaptive Token Reduction for Efficient Large Multimodal Models | 2025 | ICCV 2025 | [paper](https://arxiv.org/abs/2403.15388) | [code](https://github.com/42Shawn/LLaVA-PruMerge) |
...
| **FlashVID** | FlashVID: Efficient Video Large Language Models via Training-free Tree-based Spatiotemporal Token Merging | 2026 | ICLR 2026 | [paper](https://arxiv.org/abs/2602.08024) | — |
...
| **Video-LLaMA Q-Former** | Video-LLaMA: An Instruction-tuned Audio-Visual Language Model for Video Understanding | 2023 | arXiv | [paper](https://arxiv.org/abs/2306.02858) | [code](https://github.com/DAMO-NLP-SG/Video-LLaMA) |
| **LLaVA-Mini** | LLaVA-Mini: Efficient Image and Video Large Multimodal Models with One Vision Token | 2025 | ICLR 2025 | [paper](https://openreview.net/forum?id=UQJ7CDW8nb) | [code](https://github.com/ictnlp/LLaVA-Mini) |
...
| **VideoLLaMA 2 (STC)** | VideoLLaMA 2: Advancing Spatial-Temporal Modeling and Audio Understanding in Video-LLMs | 2024 | arXiv | [paper](https://arxiv.org/abs/2406.07476) | [code](https://github.com/DAMO-NLP-SG/VideoLLaMA2) |
| **InternVL2.5 pixel-shuffle** | Expanding Performance Boundaries of Open-Source Multimodal Models with Model, Data, and Test-Time Scaling | 2025 | arXiv | [paper](https://arxiv.org/abs/2412.05271) | [code](https://github.com/OpenGVLab/InternVL) |
| **STORM** | STORM: Token-Efficient Long Video Understanding for Multimodal LLMs | 2025 | arXiv | [paper](https://arxiv.org/abs/2503.04130) | — |
...
| **∞-Video** | \$\textbackslash infty\$-Video: A Training-Free Approach to Long Video Understanding via Continuous-Time Memory Consolidation | 2025 | arXiv | [paper](https://arxiv.org/abs/2501.19098v2) | [code](https://github.com/deep-spin/Infinite-Video) |
